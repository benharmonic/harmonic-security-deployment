...
function Configure-FirefoxExtension {
    ...
    $registry_path_firefox = "HKCU:\SOFTWARE\Policies\Mozilla\Firefox\3rdparty\Extensions\firefox-extension@harmonic.security"
...
function Configure-ChromeExtension {
    ...
    $registry_path_chrome = "HKCU:\SOFTWARE\Policies\Google\Chrome\3rdparty\extensions\$extension_identifier\policy"
...
function Configure-EdgeExtension {
    ...
    $registry_path_edge = "HKCU:\SOFTWARE\Policies\Microsoft\Edge\3rdparty\extensions\$extension_identifier\policy"
